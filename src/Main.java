...
public class Main {
	...
	public static void main(String[] args) {
		...
		String result1a = reverseWithString(test1);
		long endTime1 = System.currentTimeMillis();
		//System.out.println("String版の結果: " + result1a);
		...
		//このメソッドは逆順の比較器（Comparator）を返します。ソートメソッドと組み合わせて使用します。
		...
		// 給与の高い順にソート
		//	     Collections.sort(devEmployees, new Comparator<Employee>() {
		//	         @Override
		//	         public int compare(Employee e1, Employee e2) {
		//	             return e2.getSalary() - e1.getSalary(); // 降順ソート
		//	         }
		//	     });
...
class Employee {
	...
	public static int countCharWithStringBuilder(String str, char target) {
		StringBuilder sb = new StringBuilder(str);
		int count = 0;
		for (int i = 0; i < sb.length(); i++) {
